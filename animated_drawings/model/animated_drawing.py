...
class AnimatedDrawingRig(Transform):
    ...
    def _draw(self, **kwargs):
        ...
        # GL.glAlphaFunc(GL.GL_GREATER, 0.1)  # Adjust the threshold as necessary
...
class AnimatedDrawing(Transform, TimeManager):
    ...
    def _draw(self, **kwargs):
        ...
        if kwargs['viewer_cfg'].draw_ad_txtr:
            ...
            gray_color = (0.5, 0.5, 0.5, 1.0)  # RGBA values for gray
            default_color_loc = GL.glGetUniformLocation(kwargs['shader_ids']['texture_shader'], "defaultColor")
            GL.glUniform4f(default_color_loc, gray_color[0], gray_color[1], gray_color[2], gray_color[3])
